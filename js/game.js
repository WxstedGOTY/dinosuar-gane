...
(function (global) {
  ...
  HorizonLine.prototype = {
    /**
     * Build one tile: an unbroken ground line, a few low mounds sitting on it
    ...
    update: function (deltaTime, speed) {
      ...
      for (var j = 0; j < this.tiles.length; j++) {
        if (this.tiles[j].xPos + this.tileWidth <= 0) {
          ...
          this.tiles[j].canvas = this.makeTile();
        }
      }
    },
  ...
  GameOverPanel.prototype = {
    ...
    drawRestartButton: function () {
      ...
      var cy = this.buttonY + this.buttonSize / 2;
      var radius = 11;
